...
active_curriencies = results['data']['active_cryptocurrencies']
...
active_currencies_string = '{:,}'.format(active_curriencies)
...
print('Bitcoins\'s total percentage of the global cap is ' + str(bitcoin_percentage) + '%.')
print()
